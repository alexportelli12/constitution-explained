          ...
          <div class="flex justify-between items-center h-20">
            <div class="flex items-center">
              <div class="flex-shrink-0">
                ...
                >
                  <div class="text-primary-500 group-hover:text-primary-600">Maltese Constitution</div>
                  <div class="italic text-primary-700 group-hover:text-primary-800">Explained</div>
                </Link>
              </div>
            </div>
